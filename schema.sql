...
VALUES
('ASP-001', 'Michael Tanuwijaya (Blok A-07)', 'Penerangan Jalan (PJU)', 'Lampu PJU di dekat belokan Blok A-07 agak berkedip saat hujan', '2026-09-21', 'Diproses', 'Sudah dijadwalkan teknisi untuk dicek sambungan kabelnya Sabtu ini.', 'Sedang'),
('ASP-002', 'Ibu Citra Lestari (Blok B-01)', 'Taman & Lingkungan', 'Dahan pohon palem di median jalan utama menutupi cermin cembung', '2026-09-18', 'Selesai', 'Sudah dipangkas rapi oleh petugas kebersihan dan satpam tanggal 19 Sep.', 'Penting'),
('ASP-003', 'Wisnu Wardhana (Blok C-06)', 'Keamanan', 'Usul penambahan sensor barcode tamu di pos satpam depan', '2026-09-14', 'Ditinjau', 'Akan dibahas pada Rapat Pleno Triwulan 17 Oktober 2026.', 'Rendah')
ON CONFLICT (id) DO NOTHING;
